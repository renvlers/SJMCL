...
辱骂、骚扰或其他不可接受的行为可通过 [launcher@sjmc.club](mailto:launcher@sjmc.club) 向负责监督的社区领袖报告。
所有投诉都将得到及时和公平地审查和调查。
...
有关本行为准则的常见问题的答案，参见 [FAQ](https://www.contributor-covenant.org/faq)。
其他语言翻译参见 [更多翻译](https://www.contributor-covenant.org/translations)。

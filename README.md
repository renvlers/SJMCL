...
2. Do not remove the function of sending user statisitics to our statisitics server (`src-tauri/src/utils/sys_info.rs`), and send only version numbers different from the origin repository (e.g. `0.0.1-XX`).
